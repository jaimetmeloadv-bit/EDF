...
For EDF animated EDF summary, go <img width="528" height="330" alt="edf_soliton_braid_writhe_final" src="(https://github.com/jaimetmeloadv-bit/EDF/blob/Docs-animations/edf_soliton_braid_writhe_final.png)" />
